...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeActionFromQValues(self, state):
        ...
        maxQvalue = max(v for _, v in qvalues)
        best_action_to_take = [action for action, value in qvalues if value == maxQvalue]
        return random.choice(best_action_to_take)
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        # difference := [R(s, a, s') + y * max(Q(s' ,a'))] - Q(s, a)
